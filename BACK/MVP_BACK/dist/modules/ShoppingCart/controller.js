...
const shoppingCartControllers = {
    create: (request, response) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const DBResponse = yield models_1.ShoppingCart.create({
    ...
    findOne: (request, response) => __awaiter(void 0, void 0, void 0, function* () {
        const { ownerID } = request.params;
        try {
            const DBResponse = yield models_1.ShoppingCart.find({
                ownerID: ownerID
            });
    ...
    update: (request, response) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { items } = request.body;
        try {
            const DBResponse = yield models_1.ShoppingCart.updateOne({
                ownerID: ownerID
            }, {
                items
            });
...
exports.default = shoppingCartControllers;
