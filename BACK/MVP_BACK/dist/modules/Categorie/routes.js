...
categorieRoutes.put('/category/:name', auth_1.default, validadeCredential_1.default.ADM, controller_1.default.update);
categorieRoutes.post('/categorie', auth_1.default, validadeCredential_1.default.ADM, controller_1.default.create);
