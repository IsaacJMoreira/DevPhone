...
userRoutes.post('/logon', middlewareUsers.newUser, controller_1.default.create);
userRoutes.get('/allusers', controller_1.default.findAll);
userRoutes.get('/profile/:id', controller_1.default.findOne);
userRoutes.put('/profile/:id', middlewareUsers.updateUser, controller_1.default.update);
